...
<div class="max-w-2xl mx-auto px-6 py-16">
	...
	<div class="bg-card border border-border rounded-lg p-6">
		<div class="flex items-start gap-4 mb-6">
			<div class="w-16 h-16 bg-muted rounded-full flex items-center justify-center text-2xl font-medium overflow-hidden">
		...
		{#if data.currentUser.admin}
			<div class="flex gap-3 mt-8 pt-6 border-t border-border">
				<Button.Root variant="outline" class="flex items-center gap-2 cursor-pointer" onclick={() => goto(`/admin/users/${data.targetUser.id}/edit`)}>
