<script lang="ts">
	...
	const contactInfo: EmojiListItem[] = [
		{
			icon: '📧',
			title: 'Email',
			description: 'hello@authapp.example'
		},
		{
			icon: '📍',
			title: 'Location',
	...
	const faqItems: FAQItem[] = [
		...
		},
		{
			...
			answer:
				'Check out our <a href="/modules/auth/services" class="underline hover:text-foreground">Services page</a> to learn more.'
		}
	];
</script>

<svelte:head>
	<title>Contact - auth-app</title>
	<meta name="description" content="Get in touch with the auth-app team" />
</svelte:head>
