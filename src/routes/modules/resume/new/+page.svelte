...
<div class="max-w-4xl mx-auto px-6 py-12">
	<div class="mb-8">
		...
		<p class="text-muted-foreground mt-2">Fill in your details to generate a professional resume</p>
	</div>
		...
		<Card.Root>
			...
			<Card.Content class="space-y-6">
				{#each resumeData.experience as exp, expIndex}
					<div class="border border-border rounded-lg p-4 space-y-4">
						<div class="flex justify-between items-start">
							<h4 class="font-medium text-muted-foreground">Experience {expIndex + 1}</h4>
				...
				{#if resumeData.experience.length === 0}
					<p class="text-muted-foreground text-center py-4">No experience added yet</p>
				{/if}
			</Card.Content>
		</Card.Root>
		...
		<Card.Root>
			...
			<Card.Content class="space-y-6">
				{#each resumeData.education as edu, eduIndex}
					<div class="border border-border rounded-lg p-4 space-y-4">
						<div class="flex justify-between items-start">
							<h4 class="font-medium text-muted-foreground">Education {eduIndex + 1}</h4>
				...
				{#if resumeData.education.length === 0}
					<p class="text-muted-foreground text-center py-4">No education added yet</p>
				{/if}
			</Card.Content>
		</Card.Root>
		...
		<Card.Root>
			...
			<Card.Content class="space-y-6">
				...
				{#if resumeData.skills.length === 0}
					<p class="text-muted-foreground text-center py-4">No skills added yet</p>
				{/if}
			</Card.Content>
		</Card.Root>
		...
		<Card.Root>
			...
			<Card.Content class="space-y-6">
				{#each resumeData.projects as project, projIndex}
					<div class="border border-border rounded-lg p-4 space-y-4">
						<div class="flex justify-between items-start">
							<h4 class="font-medium text-muted-foreground">Project {projIndex + 1}</h4>
				...
				{#if resumeData.projects.length === 0}
					<p class="text-muted-foreground text-center py-4">No projects added yet</p>
				{/if}
			</Card.Content>
		</Card.Root>
