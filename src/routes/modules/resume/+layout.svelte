<script lang="ts">
	...
	const navLinks: NavLink[] = [
		{ href: '/modules/resume', label: 'My Resumes' },
		{ href: '/modules/resume/new', label: 'New Resume', requiresAuth: true },
		{ href: '/modules/resume/login', label: 'Log In', hideWhenAuth: true, testId: 'nav-login' },
		{ href: '/modules/resume/signup', label: 'Sign Up', hideWhenAuth: true, testId: 'nav-signup' },
		{
			icon: Github,
			iconSize: 'lg',
			href: 'https://github.com/mark-mcdermott/cleanroom/tree/main/src/routes/modules/resume',
			testId: 'nav-github'
		}
	];
