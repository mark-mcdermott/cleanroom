<script lang="ts">
	...
	import { products, formatPrice, getProductImage, getAvailableColors } from '$lib/data/products';
	import { ShoppingBag } from 'lucide-svelte';
</script>

<svelte:head>
	<title>Merch - Cleanroom</title>
	<meta name="description" content="Cleanroom merch - hoodies and more" />
</svelte:head>
...
<div class="max-w-6xl mx-auto px-6 py-16">
	<div class="text-center mb-12">
		...
		<p class="text-lg text-muted-foreground max-w-2xl mx-auto">
			Rep Cleanroom with our premium merch. All items are printed on-demand and shipped directly to you.
		</p>
	</div>
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
		{#each products as product}
			...
			{@const defaultColor = colors[0]?.color || 'Black'}
			{@const image = getProductImage(product, defaultColor, 'front')}
