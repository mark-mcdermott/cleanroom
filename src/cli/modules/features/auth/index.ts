...
<div class="max-w-md mx-auto px-6 py-16">
	...
	<form method="POST" use:enhance class="space-y-4">
		...
		<p class="text-center text-sm text-zinc-600">
			Don't have an account? <a href="/signup" class="text-zinc-900 underline">Sign up</a>
		</p>
	</form>
</div>
`;
...
<div class="max-w-md mx-auto px-6 py-16">
	...
	<form method="POST" use:enhance class="space-y-4">
		...
		<div>
			<label for="name" class="block text-sm font-medium text-zinc-700 mb-1">Name (optional)</label>
			<input
				type="text"
				id="name"
				name="name"
		...
		<p class="text-center text-sm text-zinc-600">
			Already have an account? <a href="/login" class="text-zinc-900 underline">Login</a>
		</p>
	</form>
</div>
`;
